...
<template>
  ...
  >
    <UCard
      ...
      class="bg-green-600 dark:bg-green-400 group-hover:bg-green-700 dark:group-hover:bg-green-300 text-slate-100 dark:text-slate-900"
    >
    ...
    <UCard
      v-else-if="numDeps <= 0"
      :ui="{ body: { padding: 'p-2 sm:p-2 lg:p-4' } }"
      class="bg-blue-600 dark:bg-blue-400 group-hover:bg-blue-700 dark:group-hover:bg-blue-300 text-slate-100 dark:text-slate-900"
    >
      <div class="flex gap-2 leading-5">
        <div>
    ...
    <UCard
      v-else
      :ui="{ body: { padding: 'p-2 sm:p-2 lg:p-4' } }"
      class="bg-red-600 dark:bg-red-400 group-hover:bg-red-700 dark:group-hover:bg-red-300 text-slate-100 dark:text-slate-900"
    >
      <div class="flex gap-2 leading-5">
        <div>
          <UIcon
